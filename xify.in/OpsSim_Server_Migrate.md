...
| <a id="TSK-MIG-004"></a>**TSK-MIG-004** | Backend | `backend/main.py` | [**DONE**] (Repo: xify.in, Branch: proDev, Commit: [2980cdc](https://github.com/xify-in/xify.in/commit/2980cdc)) Implementation of `GET /api/projects/check-name`. Implements [Path 1.1.3](#Path-1.1.3). |
